...
public class JsonDeserializer {
    ...
    public ProtocolMessage deserialize(String json) {
        ...
        return switch (jsonMessage.getMessageType()) {
            case "GameStarted" -> gson.fromJson(json, new TypeToken<ProtocolMessage<GameStarted>>() {
            }.getType());
            case "Alive" -> gson.fromJson(json, new TypeToken<ProtocolMessage<Alive>>() {
            }.getType());
            case "ActivePhase" -> gson.fromJson(json, new TypeToken<ProtocolMessage<ActivePhase>>() {
            }.getType());
            default -> null;
        };
    }
