package Desperatedrosseln.Logic.Elements;/*package Desperatedrosseln.Logic;

import Desperatedrosseln.Connection.ClientHandler;
import Desperatedrosseln.Local.Protocolss.ProtocolMessage;
import Desperatedrosseln.Local.Protocolss.SelectMap;
...
public class Game {
    ...
    public static void readyPlayer(ClientHandler client) {             //TODO: case player disconnects
        if(mapSelecttioinPlayerID == -1){
            ...
            JsonAdapter<ProtocolMessage> messageJsonAdapter = moshi.adapter(ProtocolMessage.class);
            JsonAdapter<SelectMap> selectMapJsonAdapter = moshi.adapter(SelectMap.class);
            ArrayList<String> maps = new ArrayList<>();
            maps.add("Dizzy highway");
            client.sendMessage(messageJsonAdapter.toJson(new ProtocolMessage("SelectMap",selectMapJsonAdapter.toJson(new SelectMap(maps)))));
        }
    }
